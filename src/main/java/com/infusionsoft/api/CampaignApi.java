...
public class CampaignApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void addContactsToCampaignSequenceUsingPOST(Long campaignId, Long sequenceId, InfusionsoftSetOfIds ids) throws ApiException {
        addContactsToCampaignSequenceUsingPOSTWithHttpInfo(campaignId, sequenceId, ids);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> addContactsToCampaignSequenceUsingPOSTWithHttpInfo(Long campaignId, Long sequenceId, InfusionsoftSetOfIds ids) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call addContactsToCampaignSequenceUsingPOSTAsync(Long campaignId, Long sequenceId, InfusionsoftSetOfIds ids, final ApiCallback<Void> callback) throws ApiException {
