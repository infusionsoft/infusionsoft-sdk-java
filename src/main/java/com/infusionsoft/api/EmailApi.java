...
public class EmailApi {
     ...
     * @param ordered Optional boolean to turn off ORDER BY in SQL query (optional, default to true)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listEmailsUsingGETCall(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate, Boolean ordered, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (ordered != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("ordered", ordered));
    ...
    private com.squareup.okhttp.Call listEmailsUsingGETValidateBeforeCall(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate, Boolean ordered, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listEmailsUsingGETCall(limit, offset, contactId, email, sinceSentDate, untilSentDate, ordered, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InfusionsoftEmailSentQueryResultList listEmailsUsingGET(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate, Boolean ordered) throws ApiException {
        ApiResponse<InfusionsoftEmailSentQueryResultList> resp = listEmailsUsingGETWithHttpInfo(limit, offset, contactId, email, sinceSentDate, untilSentDate, ordered);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InfusionsoftEmailSentQueryResultList> listEmailsUsingGETWithHttpInfo(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate, Boolean ordered) throws ApiException {
        com.squareup.okhttp.Call call = listEmailsUsingGETValidateBeforeCall(limit, offset, contactId, email, sinceSentDate, untilSentDate, ordered, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listEmailsUsingGETAsync(Integer limit, Integer offset, Long contactId, String email, String sinceSentDate, String untilSentDate, Boolean ordered, final ApiCallback<InfusionsoftEmailSentQueryResultList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listEmailsUsingGETValidateBeforeCall(limit, offset, contactId, email, sinceSentDate, untilSentDate, ordered, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InfusionsoftEmailSentQueryResultList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
