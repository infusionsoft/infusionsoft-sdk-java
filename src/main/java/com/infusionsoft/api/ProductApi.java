...
public class ProductApi {
    ...
    /**
     * Build call for updateProductUsingPATCH
     * @param productId productId (required)
     * @param createProduct createProduct (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateProductUsingPATCHCall(Long productId, InfusionsoftCreateProduct createProduct, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = createProduct;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateProductUsingPATCHValidateBeforeCall(Long productId, InfusionsoftCreateProduct createProduct, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'productId' is set
        if (productId == null) {
            throw new ApiException("Missing the required parameter 'productId' when calling updateProductUsingPATCH(Async)");
        }
        
        // verify the required parameter 'createProduct' is set
        if (createProduct == null) {
            throw new ApiException("Missing the required parameter 'createProduct' when calling updateProductUsingPATCH(Async)");
        }
        

        com.squareup.okhttp.Call call = updateProductUsingPATCHCall(productId, createProduct, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InfusionsoftProduct updateProductUsingPATCH(Long productId, InfusionsoftCreateProduct createProduct) throws ApiException {
        ApiResponse<InfusionsoftProduct> resp = updateProductUsingPATCHWithHttpInfo(productId, createProduct);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InfusionsoftProduct> updateProductUsingPATCHWithHttpInfo(Long productId, InfusionsoftCreateProduct createProduct) throws ApiException {
        com.squareup.okhttp.Call call = updateProductUsingPATCHValidateBeforeCall(productId, createProduct, null, null);
        Type localVarReturnType = new TypeToken<InfusionsoftProduct>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateProductUsingPATCHAsync(Long productId, InfusionsoftCreateProduct createProduct, final ApiCallback<InfusionsoftProduct> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateProductUsingPATCHValidateBeforeCall(productId, createProduct, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InfusionsoftProduct>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
