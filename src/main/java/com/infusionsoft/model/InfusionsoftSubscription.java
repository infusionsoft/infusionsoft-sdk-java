...
public class InfusionsoftSubscription {
  ...
  **/
  ...
  public InfusionsoftSubscription allowTax(Boolean allowTax) {
  ...
  **/
  ...
  public InfusionsoftSubscription saleAffiliateId(Long saleAffiliateId) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, allowTax, autoCharge, billingAmount, billingCycle, billingFrequency, contactId, creditCardId, endDate, id, nextBillDate, paymentGatewayId, productId, quantity, saleAffiliateId, startDate, subscriptionPlanId, useDefaultPaymentGateway);
  }
