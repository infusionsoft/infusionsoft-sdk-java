...
public class TagsApiTest {
    ...
    public void createTagCategoryUsingPOSTTest() throws ApiException {
        InfusionsoftTagCategory tagCategory = null;
    ...
    public void createTagUsingPOSTTest() throws ApiException {
        InfusionsoftTagModel tag = null;
        InfusionsoftTagModel response = api.createTagUsingPOST(tag);
    ...
    public void getTagUsingGETTest() throws ApiException {
        Long id = null;
        InfusionsoftTagModel response = api.getTagUsingGET(id);
    ...
    public void listTagsUsingGETTest() throws ApiException {
        ...
        Integer offset = null;
        Long category = null;
        InfusionsoftTagList response = api.listTagsUsingGET(limit, offset, category);
