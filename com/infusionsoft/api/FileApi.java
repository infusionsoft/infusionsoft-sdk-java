...
public class FileApi {
     ...
     * @param fileUpload fileUploadDTO (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listFilesUsingGETCall(Integer limit, Integer offset, String viewable, String permission, String type, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listFilesUsingGETValidateBeforeCall(Integer limit, Integer offset, String viewable, String permission, String type, String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listFilesUsingGETCall(limit, offset, viewable, permission, type, name, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InfusionsoftFileList listFilesUsingGET(Integer limit, Integer offset, String viewable, String permission, String type, String name) throws ApiException {
        ApiResponse<InfusionsoftFileList> resp = listFilesUsingGETWithHttpInfo(limit, offset, viewable, permission, type, name);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InfusionsoftFileList> listFilesUsingGETWithHttpInfo(Integer limit, Integer offset, String viewable, String permission, String type, String name) throws ApiException {
        com.squareup.okhttp.Call call = listFilesUsingGETValidateBeforeCall(limit, offset, viewable, permission, type, name, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listFilesUsingGETAsync(Integer limit, Integer offset, String viewable, String permission, String type, String name, final ApiCallback<InfusionsoftFileList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listFilesUsingGETValidateBeforeCall(limit, offset, viewable, permission, type, name, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InfusionsoftFileList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
